...
function BouncingDotsLoader({ className = '' }) {
  return (
    <div className={`flex h-4 items-end gap-1 ${className}`}>
      <div className="animation-duration-[0.6s] h-2 w-2 animate-bounce rounded-full bg-current [animation-delay:-0.3s]" />
      <div className="animation-duration-[0.6s] h-2 w-2 animate-bounce rounded-full bg-current [animation-delay:-0.15s]" />
      <div className="animation-duration-[0.6s] h-2 w-2 animate-bounce rounded-full bg-current" />
    </div>
  );
}
